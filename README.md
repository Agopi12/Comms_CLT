...
The project uses a fair die and unfair die as an example to showcase the above. It also shows how the mean of the resulting normal looking distribution is same as the underlying distribution's mean and how variance decreases with icnreasing sample size. 
